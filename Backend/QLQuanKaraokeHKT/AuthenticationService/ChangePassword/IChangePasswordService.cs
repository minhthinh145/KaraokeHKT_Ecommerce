...
namespace QLQuanKaraokeHKT.AuthenticationService.ChangePassword
{
    public interface IChangePasswordService
    {
        ...
        Task<ServiceResult> RequestChangePasswordAsync(ChangePasswordDTO changePasswordDTO , string userID);
